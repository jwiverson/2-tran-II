#Create PSL(2,9) and find a Schur cover
G:=PSL(2,9);;
...
#Test each of the nontrivial characters of G0ast for Higman pairs
List([2..8],k->RadIsHP(Gast,G0ast,lin[k]));

#Only the second one works, and it is real
alpha:=lin[2];;

#get the ETF parameters
params:=RadETFParams(Gast,G0ast,alpha);

#the result shows that PSL(2,9) only creates real lines, and the parameters are either [1,10], [9,10], or [5,10]
